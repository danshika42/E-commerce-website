    ...
    <div className='mt-8  mb-4 flex flex-col justify-center items-center m-auto w-3/4 sm:w-full '>
        ...
        <div className='border border-gray-300 rounded-md p-8 w-96 flex flex-col justify-evenly h-[25rem]'>
            ...
            {/* <form className='flex flex-col justify-evenly'> */}
                ...
                <input required value={name} onChange={(e)=>setName(e.target.value)}  type='text' className='border border-gray-300 rounded-md py-1 mb-4'/>
                <h1 className='font-semibold text-sm'>E-mail</h1>
                <input required value={email} onChange={(e)=>setEmail(e.target.value)}  type='email' className='border border-gray-300 rounded-md py-1 mb-4'/>
                <h1 className='font-semibold text-sm'>Password</h1>
                <input required value={password} onChange={(e)=>setPassword(e.target.value)} type='password' className='border border-gray-300 rounded-md py-1'/><br/>
